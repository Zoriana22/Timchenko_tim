...
function getCatalogPage() {
    ...
    charterLink1.addEventListener("click", function(event) {
        ...
        (0, _mainJs.router).navigate("/charterList");
    });
    ...
    (0, _mainJs.router).on("/charterList", async ()=>{
        page.innerHTML = "";
        const moduleSubcharter = await require("642e914115626a9");
        const subCharterGroup = moduleSubcharter.subCharter();
        page.append(subCharterGroup);
    });
    (0, _mainJs.router).resolve();
    page.append(mainTitle, /*desc*/ catalogCharters);
    return page;
}

},{"../components/mainTitle.js":"1BNwr","../components/desc.js":"7kCFx","../main.js":"1SICI","642e914115626a9":"3F2WF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3F2WF":[function(require,module,exports) {
module.exports = require("57f675140d3132a")(require("c4a2191933dbcd14").getBundleURL("dtSDt") + "charterList.1956f1c4.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("6Lqqv"));

},{"57f675140d3132a":"61B45","c4a2191933dbcd14":"lgJ39"}]},["gKH8p"], null, "parcelRequire08cb")
